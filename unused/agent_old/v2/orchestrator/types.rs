...
use crate::agent_old::{Agent, AgentV2};
...
pub struct AgentOrchestrator {
    ...
    pub escalation_tx: Option<Sender<(crate::agent_old::tools::worker_shell::EscalationRequest, tokio::sync::oneshot::Sender<crate::agent_old::tools::worker_shell::EscalationResponse>)>>,
    /// Receiver for worker escalation requests
    pub escalation_rx: Arc<Mutex<Option<Receiver<(crate::agent_old::tools::worker_shell::EscalationRequest, tokio::sync::oneshot::Sender<crate::agent_old::tools::worker_shell::EscalationResponse>)>>>>,
