...
pub struct JobRegistry {
    ...
    event_bus: Arc<RwLock<Option<Arc<crate::agent::event_bus::EventBus>>>>,
}
...
impl JobRegistry {
    ...
    pub fn set_event_bus(&self, event_bus: Arc<crate::agent::event_bus::EventBus>) {
        *self.event_bus.write() = Some(event_bus);
    }

    /// Get the event bus if available
    pub fn get_event_bus(&self) -> Option<Arc<crate::agent::event_bus::EventBus>> {
