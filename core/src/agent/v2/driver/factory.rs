...
impl AgentConfigs {
    ...
    pub fn one_shot(
        ...
        terminal_executor: Arc<dyn crate::agent::traits::TerminalExecutor>,
        store: Arc<crate::memory::store::VectorStore>,
        categorizer: Option<Arc<crate::memory::MemoryCategorizer>>,
        job_registry: crate::agent::v2::jobs::JobRegistry,
        permissions: Option<crate::config::v2::types::AgentPermissions>,
        web_search_config: crate::config::WebSearchConfig,
        crawl_event_bus: Arc<crate::agent::event_bus::EventBus>,
