...
pub use memory::{MemoryCapability, MemoryEntry, MemoryCategory, VectorStore, StubVectorStore};
pub use vector_store::{InMemoryVectorStore, VectorEntry, SearchResult, SimpleEmbedder};
