...
use crate::agent::runtime::contract_runtime::OutputSender;
use crate::agent::runtime::tools::scratchpad::create_shared_scratchpad;
...
pub struct DelegateTool {
    ...
    parent_tools: Arc<dyn crate::agent::runtime::capability::ToolCapability>,
    /// Factory for creating worker sessions (single source of truth)
    factory: crate::agent::AgentSessionFactory,
    /// LLM client for workers
    llm_client: Option<Arc<crate::provider::Client>>,
    /// Maximum concurrent workers
    max_workers: usize,
    /// Default max iterations per worker
    default_max_iterations: usize,
    /// Escalation channel for shell commands
    escalation_tx: Option<mpsc::Sender<(crate::agent::runtime::tools::worker_shell::EscalationRequest, oneshot::Sender<crate::agent::runtime::tools::worker_shell::EscalationResponse>)>>,
...
impl DelegateTool {
    ...
    pub fn with_llm_client(mut self, client: Arc<crate::provider::Client>) -> Self {
    ...
    pub fn with_escalation_channel(
        mut self,
        tx: mpsc::Sender<(crate::agent::runtime::tools::worker_shell::EscalationRequest, oneshot::Sender<crate::agent::runtime::tools::worker_shell::EscalationResponse>)>,
    ) -> Self {
