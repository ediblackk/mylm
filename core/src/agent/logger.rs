...
macro_rules! debug_log {
    ($($arg:tt)*) => {
        // Emit structured log with inferred component (includes module path format)
        {
            use $crate::agent::logger::infer_component_from_module;
            let component = infer_component_from_module(module_path!());
            $crate::agent::logger::log_with_event(
                $crate::agent::logger::LogLevel::Debug,
                component,
                $crate::agent::logger::LogEvent::AgentStep, // generic event for debug
                format!($($arg)*)
            );
        }
    };
...
macro_rules! info_log {
    ($($arg:tt)*) => {
        // Emit structured log with inferred component (includes module path format)
        {
            ...
            let component = infer_component_from_module(module_path!());
            $crate::agent::logger::log_with_event(
                $crate::agent::logger::LogLevel::Info,
                component,
                $crate::agent::logger::LogEvent::AgentStep, // generic event for info
                format!($($arg)*)
            );
        }
    };
...
macro_rules! warn_log {
    ($($arg:tt)*) => {
        // Emit structured log with inferred component (includes module path format)
        {
            ...
            let component = infer_component_from_module(module_path!());
            $crate::agent::logger::log_with_event(
                $crate::agent::logger::LogLevel::Warn,
                component,
                $crate::agent::logger::LogEvent::AgentError, // generic event for warn
                format!($($arg)*)
            );
        }
    };
...
macro_rules! error_log {
    ($($arg:tt)*) => {
        // Emit structured log with inferred component (includes module path format)
        {
            ...
            let component = infer_component_from_module(module_path!());
            $crate::agent::logger::log_with_event(
                $crate::agent::logger::LogLevel::Error,
                component,
                $crate::agent::logger::LogEvent::AgentError,
                format!($($arg)*)
            );
        }
    };
...
macro_rules! trace_log {
    ($($arg:tt)*) => {
        // Emit structured log with inferred component (includes module path format)
        {
            ...
            let component = infer_component_from_module(module_path!());
            $crate::agent::logger::log_with_event(
                $crate::agent::logger::LogLevel::Trace,
                component,
                $crate::agent::logger::LogEvent::AgentStep, // generic event for trace
                format!($($arg)*)
            );
        }
    };
