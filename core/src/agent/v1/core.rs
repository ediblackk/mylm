...
use crate::agent::v2::AgentV2Config;
...
pub struct AgentConfig {
    ...
    pub job_registry: Option<crate::agent::v2::jobs::JobRegistry>,
    ...
    pub event_bus: Option<Arc<crate::agent::event_bus::EventBus>>,
...
impl Agent {
    ...
    fn convert_v2_decision(&self, v2_decision: crate::agent::v2::AgentDecision) -> AgentDecision {
        match v2_decision {
            crate::agent::v2::AgentDecision::Message(msg, usage) => AgentDecision::Message(msg, usage),
            crate::agent::v2::AgentDecision::Action { tool, args, kind } => AgentDecision::Action {
                tool,
                args,
                kind,
            },
            crate::agent::v2::AgentDecision::MalformedAction(error) => AgentDecision::MalformedAction(error),
            crate::agent::v2::AgentDecision::Error(e) => AgentDecision::Error(e),
            crate::agent::v2::AgentDecision::Stall { reason, tool_failures } => AgentDecision::Stall { reason, tool_failures },
        }
    }
    ...
    pub async fn handle_approval_flow(
        ...
        crate::agent::execution::handle_tool_approval(
            tool,
            args,
