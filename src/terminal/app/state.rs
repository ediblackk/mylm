...
impl AppStateContainer {
    pub fn new(
        ...
        let context_manager = ContextManager::new(mylm_core::context::ContextConfig::new(max_ctx));
    ...
    pub fn toggle_focus(&mut self) {
        self.focus = match self.focus {
            ...
            Focus::Chat => {
                // Only focus Jobs if panel is visible
    ...
    /// Cycle focus forward (Terminal → Chat → Jobs → Terminal)
    #[allow(dead_code)]
