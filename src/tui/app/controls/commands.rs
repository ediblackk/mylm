            ...
            "list" => {
                ...
                for job in &jobs[..jobs.len().min(20)] { // Show last 20
                    let status_icon = match job.status {
                        crate::tui::app::types::JobStatus::Running => "⏳",
                        crate::tui::app::types::JobStatus::Completed => "✅",
                        crate::tui::app::types::JobStatus::Failed => "❌",
                        crate::tui::app::types::JobStatus::Cancelled => "🛑",
                        crate::tui::app::types::JobStatus::TimeoutPending => "⏱",
                        crate::tui::app::types::JobStatus::Stalled => "⚠️",
                    };
                    msg.push_str(&format!(
                        "{} {} | {} | {:?}\n",
                        status_icon,
